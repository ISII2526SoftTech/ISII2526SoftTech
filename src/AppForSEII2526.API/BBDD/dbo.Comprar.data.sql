...
VALUES
('Calle Falsa 123, Madrid', '2025-11-01 10:30:00', 125.50, 0, '1001'); -- MetodoPago: 0 = TarjetaCredito

INSERT INTO dbo.Comprar (DireccionEnvio, FechaCompra, PrecioTotal, MetodoPago, ApplicationUserId)
VALUES
('Avenida Principal 45, Barcelona', '2025-11-05 15:45:00', 89.90, 1, '1002'); -- MetodoPago: 1 = PayPal

INSERT INTO dbo.Comprar (DireccionEnvio, FechaCompra, PrecioTotal, MetodoPago, ApplicationUserId)
VALUES
('Plaza Central 7, Valencia', '2025-11-10 09:15:00', 240.00, 2, '1003'); -- MetodoPago: 2 = Efectivo
